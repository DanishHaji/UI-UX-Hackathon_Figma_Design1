...
export default async function CarDetails({
  ...
  return (
    <div className="w-full flex flex-col bg-[#f6f7f9]">
      <div className="sec w-full p-4 sm:p-6 flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
            ...
            <Card className="flex flex-col w-full lg:max-w-[492px] h-auto lg:h-[508px]">
              <CardHeader>
                <CardTitle className="w-full flex items-center justify-between">
                  {car.name} <Image src={"/heart.png"} alt="Favorite Icon" width={20} height={20} />
                </CardTitle>
            ...
            <div className="p-4 flex items-center justify-between gap-4">
              <div className="flex flex-col">
                <h1 className="font-bold text-lg sm:text-xl lg:text-2xl">
                  {car.pricePerDay} / <span className="text-gray-500 text-sm lg:text-base">day</span>
                </h1>
                <h1 className="text-red-600 line-through">{car.originalPrice}</h1>
              </div>
        ...
        {/* Review Section */}
        <section className="review-section w-full flex flex-col gap-10 p-4">
          <ReviewsSection carId={car._id} />  {/* Add the ReviewSection here */}
        </section>
              ...
              <div key={car._id}>
                <Card className="w-full max-w-[304px] mx-auto h-[388px] flex flex-col justify-between">
                  ...
                  <CardFooter className="flex items-center justify-between p-2">
                    <div className="text-lg text-gray-500">{car.pricePerDay}</div>
                    <Link href={`/payment/${car.slug.current}`}>
                      <button className="bg-[#3563e9] hover:bg-[#264ac6] transition-all p-3 sm:p-4 px-6 sm:px-10 text-white rounded-md w-full max-w-[180px] text-center">
                        Rent Now
                      </button>
                    </Link>
                  </CardFooter>
